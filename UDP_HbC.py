...
#retrieve interval in which packets will be lost
startPackDrop = int(argv[3])
endPackDrop = int(argv[4])

#list of all rtt's
rtTimes = []

#keep track of packets sent and lost
packSent = 0
packLost = 0
...
for sequence_number in range(1, 51):
    ...
    #artificially drop packets within the interval
    if startPackDrop <= sequence_number <= endPackDrop:
        continue
    ...
    try:
        ...
        #increment the num of packets lost
        packLost += 1
